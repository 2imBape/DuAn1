        ...
        <div class="row px-xl-5">
            ...
            ?>    
                ...
                <div class="col-lg-7 pb-5">
                    <h3 class="font-weight-semi-bold"><?php echo $ten_san_pham ?></h3>
                    ...
                    <h3 class="font-weight-semi-bold mb-4"><?php echo $gia ?>.000 ₫</h3>
                    <p class="mb-4"><?php echo $mo_ta ?></p>
                    <div class="d-flex mb-3">
                        <p class="text-dark font-weight-medium mb-0 mr-3">Sizes:</p>
                        <form>
                            <div class="custom-control custom-control-inline">
                                <label class="" for="size-1"><?php echo $size ?></label>
                            </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                            <form action="index.php?act=addtocart" method="POST">
                                    ...
                                    <div class="input-group-btn">
                                        <a class="btn btn-primary" onclick="handleMinus()" >
                                            <i class="fa fa-minus"></i>
                                        </a>
                                    </div>
                                    <input type="text" class="form-control  text-center" name="amount" id="amount" value="1">
                                    <div class="input-group-btn">
                                        <a class="btn btn-primary" onclick="handlePlus()">
                            ...
                            <div class="col-md-6">
                                ...
                                ?>
                                    <div class="media-body">
                                        ...
                                        <h6><?php echo $bl['account']?><small> - <i><?php echo $bl['ngay_danh_gia'] ?></i></small></h6>                                        
                                        ...
                                        echo'                                                          
                                            <form action="index.php?act=spct&idsp="'.$id.' method="post">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="" name="noi_dung" cols="30" rows="5" class="form-control"></textarea>
                                                </div>
